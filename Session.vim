...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/linediff,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set softtabstop=8
...
set shortmess=aoO
badd +0 anki.txt
badd +0 index-base.txt
badd +0 ~/sam/index.txt
argglobal
silent! argdel *
argadd anki.txt
edit index-base.txt
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 55 - ((21 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
